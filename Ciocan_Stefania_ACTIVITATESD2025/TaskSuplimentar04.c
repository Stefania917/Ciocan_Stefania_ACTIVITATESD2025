...
//	}
//}
////Creati o functie care sa copieze (deep copy) elementele din vector intr-o matrice alocata
//// dinamic.Asezarea in matrice pe linii a obiectelor o faceti dupa un criteriu aplicat unui
//// atribut.Astfel veti ob?ine mai multe clustere reprezentate de liniile matricei.
//
//
//
////Scrieti o functie care muta liniile din matrice, astfel incat acestea sa fie sortate dupa numarul
